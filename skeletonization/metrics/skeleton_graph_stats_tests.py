...
def test_cutoff():
    single_line_arr = graph_helpers.get_single_line()
...
class SkeletonStatsTestsCyclicGraph(unittest.TestCase):
    ...
    def setUp(self):
        self.tiny_loop_branch_stat = _helper_skeleton_stats(
            graph_helpers.get_tiny_loop_with_branches())
...
class SkeletonStatsTestsTree(unittest.TestCase):
    ...
    def setUp(self):
        self.tree_stat = _helper_skeleton_stats(graph_helpers.get_disjoint_trees_no_cycle_3d())
...
class SkeletonStatsTestsCyclesGraph(unittest.TestCase):
    def setUp(self):
        self.cycles_branches_stat = _helper_skeleton_stats(
            graph_helpers.get_tiny_loops_with_branches())
